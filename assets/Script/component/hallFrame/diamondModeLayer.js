...
cc.Class({
    ...
    selectGameLevel:function(event, customEventData){
        ...
        {
            if(this.curMode == 1){
                this.curGameType = "goldNiuNiu-1-diamond";
                this.matchTips0.string = "普通牛牛初级场";
            }
            else{
                this.curGameType = "goldMingpai-1-diamond";
                this.matchTips0.string = "明牌抢庄初级场";
            }
            this.beginMatch();
        }else if(index == 2){
            if(this.curMode == 1){
                this.curGameType = "goldNiuNiu-2-diamond";
                this.matchTips0.string = "普通牛牛中级场";
            }
            else{
                this.curGameType = "goldMingpai-2-diamond";
                this.matchTips0.string = "明牌抢庄中级场";
            }
            this.beginMatch();
        }else if(index == 3){
            if(this.curMode == 1){
                this.curGameType = "goldNiuNiu-3-diamond";
                this.matchTips0.string = "普通牛牛高级场";
            }
            else{
                this.curGameType = "goldMingpai-3-diamond";
        ...
        pomelo.request("connector.entryHandler.sendData", {"code" : "joinMatch","params" : {
            gameType: self.curGameType}}, function(data) {
              ...
              if(data.flag == true)
              {
                ...
                self.curMatchTime = 0;
                self.matchTips.string = "正在匹配:0S";
                
                self.timeUpdate = function () {
                    self.curMatchTime++;
                    self.matchTips.string = "正在匹配:"+self.curMatchTime+"S";
                };
