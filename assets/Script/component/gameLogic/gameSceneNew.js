        ...
        var showSettleFunc1 = function(){
            ...
            for(var i in data.result)
            {
                if(data.result.hasOwnProperty(i))
                {
                    ...
                    if(self.isFengKuang)
                        self.gameInfoNode.settleLayer.addOneSettle(confige.roomData.player[i].playerInfo.nickname, niuType, data.curScores[i],1);
                    else
                        self.gameInfoNode.settleLayer.addOneSettle(confige.roomData.player[i].playerInfo.nickname, niuType, data.curScores[i],0);
