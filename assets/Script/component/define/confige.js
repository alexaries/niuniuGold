...
cfg.goldType = {
  "goldMingpai-1-gold" : "初级场",
  "goldMingpai-2-gold" : "中级场",
  "goldMingpai-3-gold" : "高级场",
  "goldNiuNiu-1-gold" : "初级场",
  "goldNiuNiu-2-gold" : "中级场",
  "goldNiuNiu-3-gold" : "高级场",
  "goldMingpai-1-diamond" : "初级场",
  "goldMingpai-2-diamond" : "中级场",
  "goldMingpai-3-diamond" : "高级场",
  "goldNiuNiu-1-diamond" : "初级场",
  "goldNiuNiu-2-diamond" : "中级场",
  "goldNiuNiu-3-diamond" : "高级场"
};
...
cfg.APP_ID = "wx949076bad1439cbd";
cfg.SECRET = "dc31862522335ce0c16c10045fdb5351";
cfg.WX_CODE = "";
cfg.WX_ACCESS_TOKEN = "";
cfg.WX_OPEN_ID = "";
cfg.WX_UNIONID = "";
...
//
cfg.quitToHallScene = function(showProgress){
  if(showProgress == true)
  {
    cc.loader.onProgress = function(completedCount, totalCount, item) {
        ...
        if(totalCount > 10){
            cfg.loadNode.showNode();
            cfg.loadNode.setProgress(progress,numString);
        }
    };
  }
  cc.director.loadScene('HallScenePlus');
  if(cfg.curGameScene.gameInfoNode.yuyinTimeOut != -1)
